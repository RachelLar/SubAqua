		...
		if ($p) 
			{ // Then, IF everything is set correctly
				...
				if (mysqli_affected_rows($dbc) == 1) 
                                    { //  Then, IF everything ran correctly
					...
					exit();
                                    ...
                                    { // ELSE, if everything it did not run correctly		
                                            echo '<div class="alert alert-danger" role="alert"><p class="error">Your password was not changed. Make sure your new password is different than the current password. Contact the system administrator if you think an error occurred.</p></div>'; 
                                    }
