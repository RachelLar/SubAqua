...
function my_error_handler ($e_number, $e_message, $e_file, $e_line, $e_vars) 
	{
		...
		if (!LIVE) { // Development (print the error).
			...
			echo '<div class="error alert alert-danger" role="alert">' . nl2br($message);
			...
			{ // Don't show the error:
				...
				if ($e_number != E_NOTICE) {
					echo '<div class="error alert alert-danger" role="alert">A system error occurred. We apologize for the inconvenience.</div><br />';
				}
			} // End of !LIVE IF.
