        ...
        <div class="container">       
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <!--<ul class="nav navbar-nav">
                    ...
                    <li><a href="member_page2.php"><strong></strong></a></li>    
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 scheme2">
                    <h1 class="page-header">Admin Add Member Admin Info</h1>
                    <ol class="breadcrumb  btn-primary" >
                        <li><a href="admin_home.php">Admin</a></li>
                        <li class="active" id="scheme2">Add Member Admin Info</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12 scheme2"> 
                    ...
                    <!--This will display the html registration form-->
                        <h1 class="textwhite">Add Member Admin Info</h1> 
                        
                        <form class="form-group" role="form" action="add_member_info.php" method="post">
                            ...
                            <div class="form-group form-group-sm">
                                <input type="text" name="bsac" placeholder="BSAC" class="form-control input-md text-center" size="30" maxlength="30" value="<?php if (isset($trimmed['bsac'])) echo $trimmed['bsac']; ?>" />
                            </div>
                            <div class="form-group form-group-sm">
                                <input type="text" name="solent" placeholder="Solent" class="form-control input-md text-center" size="30" maxlength="30" value="<?php if (isset($trimmed['solent'])) echo $trimmed['solent']; ?>" />
                            </div>
                            <div class="form-group form-group-sm">
                                <input type="text" name="andark" placeholder="Andark" class="form-control input-md  text-center" size="30" maxlength="30" value="<?php if (isset($trimmed['andark'])) echo $trimmed['andark']; ?>" />
                            </div>
                            <div class="form-group form-group-sm">
                                <input type="text" name="polo" placeholder="Polo" class="form-control input-md  text-center" size="30" maxlength="30" value="<?php if (isset($trimmed['polo'])) echo $trimmed['polo']; ?>" />
                            </div>
