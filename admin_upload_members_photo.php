        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 scheme2">
                    <h1 class="page-header">Admin Upload Member Photo</h1>
                    <ol class="breadcrumb  btn-primary" >
                        <li><a href="admin_home.php">Admin</a>
                        </li>
                        <li class="active" id="scheme2">Upload Member Photo</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12 scheme2"> 
                    ...
                    <!--This will display the html registration form-->
                        <h1 class="textwhite">Upload Member Photo</h1> 
                        <p class="textwhite">Select a file of 2MB or smaller.</p>
                        <form class="form-group" role="form" enctype="multipart/form-data" action="upload_photo.php" method="post">
                            <input type="hidden" name="MAX_FILE_SIZE" value="2000000" />
                                <div class="form-group form-group-sm">
                                   <input type="text" name="member_info_member_info_id" placeholder="Exact Member Info ID Number" class="form-control input-md  text-center" id="inputTopicId" size="30" maxlength="30" value="<?php if (isset($trimmed['member_info_member_info_id'])) echo $trimmed['member_info_member_info_id']; ?>" />
                                </div>
